  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Framsteg: när du har kopplade barn ser du kort med nyckeltal och summering per barn (närvaro, läxor, senaste aktivitet) endast för dina barn.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Delade länkar kan använda ?childId=<id> för att öppna samma drawer.",
      ],
    },
    {
      id: "notifications",
